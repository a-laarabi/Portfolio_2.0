...
const projectsObj = [
  {
    ...
    homeImg: require('./img/projects/coffeShopPhone.png'),
  ...
  // },
  {
    ...
    backImg: require('./img/projects/spaceHub.png'),
    homeImg: require('./img/projects/spaceHubTab.jpg'),
    PhoneImg: require('./img/projects/spaceHubTab.jpg'),
    tabImg: require('./img/projects/spaceHubTabSecond.jpg'),
    projectDetailSecond: 'Back End Dev',
    projectDate: '09-2022',
